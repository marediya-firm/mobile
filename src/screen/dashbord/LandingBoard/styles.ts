...
export const fillStyles = (...params: Array<number | number | boolean | any>) => {
    // console.log("params",params);

    return {
        backgroundColor: (params[2] && params[3]?.length - 1 == params[1]) ? Colors.semiGreen : params[2]
            ? Colors.semiGreen : params[0] == params[1] ? Colors.semiGrey : 'red',
    }
}